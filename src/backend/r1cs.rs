    ...
    fn cursor_circuit(&mut self) {
        for j in 0..self.batch_size {
            ...
            if j == 0 {
                        ...
                        term(
                            ...
                            vec![
                                term(
                                    Op::BoolNaryOp(BoolNaryOp::And),
                                    vec![
                                        term(Op::Not, vec![self.not_forall_circ(j)]),
                                        lmtd_push_cond,
                                    ],
                                ),
                                new_const(1),
                ...
                let lmtd_pop_cond = term(Op::Eq, vec![new_const(3), new_var(format!("rel_{}", 0))]);
